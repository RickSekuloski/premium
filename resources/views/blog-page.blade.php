...
@section('content')
           ...
           <div class="row post-image">
               <div class="col-md-12">
                  <img src="img/vuejs.jpg" class="post-image__style" alt="Blog Main Image">
               </div>
               ...
               <div class="col-md-8 offset-2 post-image__author">
                   ...
                   <div class="post-image__author-image-container">
                       <img src="img/profile-img-not-available.png" alt="Author Image" class="post-image__author-img">
                   </div>
           ...
           <div class="col-md-8 offset-2 post-container__title">
               <div class="text-center">Title goes Here</div>
           </div>
          ...
          <div class="col-md-8 offset-2 post-container__body">
              <div class="">
                  ...
                  Quae inventore, labore dolorum blanditiis illum amet quaerat 
                  necessitatibus ratione 
                  tempore ullam dolor enim. Atque fugiat consequatur maiores 
                  autem culpa assumenda maxime!
              </div>
          </div>
